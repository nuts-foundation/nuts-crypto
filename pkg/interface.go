...
type Client interface {
	...
	// SignTLSCertificate creates a CSR for the given legalEntity and public key and will sign it with the vendorCA.
	// It differs from GetTLSCertificate in the fact that the private key is unknown.
	SignTLSCertificate(entity types.LegalEntity, publicKey crypto.PublicKey) (*x509.Certificate, error)
